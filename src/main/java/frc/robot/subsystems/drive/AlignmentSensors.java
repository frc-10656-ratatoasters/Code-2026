...
public class AlignmentSensors extends SubsystemBase {
    ...
    public AlignmentSensors() {
        ...
        canrangeConfig.ProximityParams.MinSignalStrengthForValidMeasurement = 2000; // minimun signal strength for
                                                                                    // measurement
        canrangeConfig.ProximityParams.ProximityThreshold = Units.feetToMeters(2); // how far away the CANrange will say
                                                                                   // stuff "is detected"

        canrangeConfig.ToFParams.UpdateMode = UpdateModeValue.ShortRange100Hz; // fastest update speed, may need to
                                                                               // change later
    ...
    public Pose2d getAlignTargetPose() {
        ...
        return new Pose2d();//Check this code to make sure it does what we want
    }
